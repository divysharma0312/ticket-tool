...
const { Database, name } = require("quickmongo");
const db = new Database(process.env.Mongo)
const randomstring = require("randomstring");
const disbut = require('discord-buttons');
require('discord-buttons')(client);
const { MessageMenu, MessageMenuOption, default: discordButtons } = require('discord-buttons');
...
client.on('ready', async () => {
  ...
  console.log(`Made by Cyber'#7379`)
  console.log(`Credits | NIGHT SHOP | https://discord.gg/TFj3AXgQ6Y`)
...
> \`${prefix}setstaff\` - set staff roles`)
      .setTimestamp()
      .setColor(0x5865F2)
      .setFooter(`All rights belong to https://discord.gg/TFj3AXgQ6Y`)
...
client.login("ODc3NTc0NTUxMzg5NzQxMDU2.YR0m_Q.OurLWgAvYB7d1h-W8PBciBzCcWo");
